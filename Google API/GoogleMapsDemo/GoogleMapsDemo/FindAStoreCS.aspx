<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FindAStoreCS.aspx.cs" Inherits="FindAStoreCS" %>
                ...
                <ItemTemplate>
                    <li>
                        <asp:HyperLink ID="lnkSelectDYM" runat="server"
                                       NavigateUrl='<%# string.Format("ShowStoreLocationsCS.aspx?Address={0}", Server.UrlEncode(Container.DataItem.ToString())) %>'
